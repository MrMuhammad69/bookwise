...
const BookOverView = ({title, author, genre, rating, total_copies, available_copies, description,color, cover,id,summary,video,isLoanedBook}: Book) => {
  return (
   <section className='book-overview'>
    <div className='flex flex-1 flex-col gap-5'>
        ...
        <div className='book-info'>
          ...
          <p>
            Category:{" "} <span className='font-semibold text-light-200'>
              {genre}
            </span>
          </p>
